...
<br>
	...
	<br><br>
	 ...
	 Your code:<br>
	  <textarea name="code" readonly="readonly" style="width:600px;height:290px;"><%=session.getAttribute("studentcode") %></textarea>
	 
	
	 </td>
	 <td style="width:30%">

	<a href="student_testsavecodetransition.jsp"><button type="button">Save your code.</button></a>
