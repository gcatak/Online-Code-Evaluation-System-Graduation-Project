...
<%
    ...
    String inputfile = request.getParameter("instructorinputfile");
    String outputfile = request.getParameter("instructoroutputfile");
...
<br>
<div align="center"> 
Your input-output set is saved. <br><br>
<a href="input_output.jsp"> Go to back page.</a>
</div> 
</body>
