...
<form action=problem.jsp method=post> 
   ...
   <td> <select>
  	<option value="pr1">HW1</option>
  	<option value="pr2">HW2</option>
  	<option value="pr3">HW3</option>
  	<option value="pr4">Project1</option>
	</select>
	</td>
	<td>
	 <select>
  	<option value="io1">I/O 1</option>
  	<option value="io2">I/O 2</option>
  	<option value="io3">I/O 3</option>
  	<option value="io4">I/O 4</option>
  	<option value="io5">I/O 5</option>
	</select>
	</td>
