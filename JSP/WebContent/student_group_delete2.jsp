...
<%
    ...
    String deletedgroup =(String)session.getAttribute("deletedgroup");    
 ...
 //   ResultSet rs;
    ...
    String hwselectedd=(String)session.getAttribute("hws");
    String sql = "DELETE FROM groupp_student WHERE name= ?";

    PreparedStatement ps = con.prepareStatement(sql);
    ps.setString(1, deletedgroup);
 //   ps.setString(2, deletedpass);

    ps.executeUpdate();
    
    
    String sql2 = "DELETE FROM groupp WHERE name= ?";

    PreparedStatement ps2 = con.prepareStatement(sql2);
    ps2.setString(1, deletedgroup);
   ...
   // out.println(deletedcourse + deletedpass);
    ...
    response.sendRedirect("student_hw.jsp?hwselecteds=" + hwselectedd);
